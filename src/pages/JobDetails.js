...
import { useApplyJobMutation, useJobByIdQuery, useQuestionMutation, useReplyMutation } from "../features/api/apiSlice";
...
const JobDetails = () => {
  ...
  const { data, } = useJobByIdQuery(id, { pollingInterval: 500 });
